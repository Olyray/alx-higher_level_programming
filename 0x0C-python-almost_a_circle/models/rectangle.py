#!/usr/bin/python4
"""This is the module for a rectangle"""
...
class Rectangle(Base):
    """
    The Rectangle class inherits from the Base class and adds
    additional functionality for width, height, x, and y.
    """

    def __init__(self, width, height, x=0, y=0, id=None):
        """
        The class constructor for the Rectangle class.
