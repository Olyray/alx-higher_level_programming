...
class Rectangle:
    ...
    def square(cls, size=0):
        """
        Converts an instance of a Rectangle to a square.

        Args:
            cls (Rectangle): this is the class
            size (int): this is the proposed size of the square
        Return:
            Rectangle: the new Rectangle class.
        """
